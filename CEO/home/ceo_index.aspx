<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ceo_index.aspx.cs" Inherits="CEO_ceo_index" %>
	...
	<div class="banner-w3-agileits-slider">
		<div class="overlay overlay-contentpush">
			...
			<nav>
				<ul>
					<li>
						<a href="ceo_index.aspx">Home</a>
					</li>
					<li>
						<a href="../manage_employee.aspx">Manage Employees</a>
					</li>
					<li>
						<a href="../manage_roles.aspx">Manage Roles</a>
					</li>
					<li>
						<a href="../set_roles_to_employees.aspx">Set Roles To Employee</a>
					</li>
					<%--<li>
						<a href="../view_roles_to_employee.aspx">View Roles To Files</a>
					</li>--%>
                    <li>
						<a href="../Approve_requests.aspx">View Requests</a>
					</li>
					<li>
						<a href="../view_files.aspx">View Files </a>
					</li>
                    <li>
						<a href="../Remove_Employees.aspx">Remove Employees </a>
					</li>
					<li>
