...
<div class="services-breadcrumb">
	<div class="agile_inner_breadcrumb">
	   <ul class="w3_short">
			...
			<li>View Files & Permitted Roles</li>
		</ul>
	</div>
</div>
<!-- //w3_short -->
            ...
            <div class="col-lg-12">
                   <div class="copy">
                    <div class="text-center">
                        <br /><br />
                        <asp:Label ID="Label2" runat="server" Text="View Files & Permitted Roles" ForeColor="#800000" Font-Size="Large"></asp:Label>
                         </div>
                        <br />
                        <br />
			...
			<div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="text-center">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" BorderColor="#6699FF" BorderStyle="Solid"  BorderWidth="5px" >
                              <Columns>
