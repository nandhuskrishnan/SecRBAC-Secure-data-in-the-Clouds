<%@ Page Language="C#" AutoEventWireup="true" CodeFile="modify_fileaspx.aspx.cs" Inherits="Employee_modify_fileaspx" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class=" text-center">
                            <asp:Label ID="Label2" runat="server" Text="MODIFY YOUR FILES" ForeColor="#cc0000" Font-Size="Large" ></asp:Label>
                        </div>
                        <br />
                        

                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-reponsive" BorderColor="#6699FF" OnRowCommand="GridView1_RowCommand" >
                              <Columns>
                             ...
                             <asp:BoundField DataField="discription" HeaderText="Discription" />
                                ...
                                <asp:BoundField DataField="date" HeaderText="Upload Date" />
                                 <asp:TemplateField>
                                  ...
                                  <asp:TemplateField>
                                      <ItemTemplate>
                                          <asp:Button ID="Button1" runat="server" Text="Modify" CssClass="btn btn-sm btn-primary" CommandArgument='<%# bind("fname") %>' CommandName="mod" />
                                      </ItemTemplate>
                                  </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
